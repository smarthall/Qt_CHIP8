...
void Chip8Core::opcode_misc_zero(uint16_t opcode)
{
    switch (opcode) {
...
void Chip8Core::opcode_jmp(uint16_t opcode)
{
    pc = opcode & 0x0FFF;
}

void Chip8Core::opcode_call(uint16_t opcode)
{
    stack[sp++] = pc;
    pc = opcode & 0x0FFF;
}

void Chip8Core::opcode_se(uint16_t opcode)
{
...
void Chip8Core::opcode_sne(uint16_t opcode)
{
    uint8_t x = (opcode & 0x0F00) >> 8;
    uint8_t n = opcode & 0x00FF;
    if (V[x] != n) {
...
void Chip8Core::opcode_se2(uint16_t opcode)
{
    uint8_t x = (opcode & 0x0F00) >> 8;
...
void Chip8Core::opcode_ldn(uint16_t opcode)
{
    uint8_t x = (opcode & 0x0F00) >> 8;
    uint8_t n = opcode & 0x00FF;
    V[x] = n;
...
void Chip8Core::opcode_add(uint16_t opcode)
{
    uint8_t x = (opcode & 0x0F00) >> 8;
    uint8_t n = opcode & 0x00FF;
    uint16_t res = V[x] + n;
...
void Chip8Core::opcode_registers(uint16_t opcode)
{
...
void Chip8Core::opcode_skp(uint16_t opcode)
{
    uint8_t x = (opcode & 0x0F00) >> 8;
    uint8_t y = (opcode & 0x00F0) >> 4;
    if (V[x] == V[y]) {
...
void Chip8Core::opcode_ldi(uint16_t opcode)
{
    I = opcode & 0x0FFF;
    pc += 2;
}

void Chip8Core::opcode_jmpi(uint16_t opcode)
{
    pc = (opcode & 0x0FFF) + V[0];
}

void Chip8Core::opcode_rnd(uint16_t opcode)
{
    uint8_t x = (opcode & 0x0F00) >> 8;
    uint8_t n = opcode & 0x00FF;
    V[x] = std::rand() & n;
...
void Chip8Core::opcode_draw(uint16_t opcode)
{
    uint8_t x = (opcode & 0x0F00) >> 8;
    uint8_t y = (opcode & 0x00F0) >> 4;
...
void Chip8Core::opcode_key(uint16_t opcode)
{
    uint8_t x = (opcode & 0x0F00) >> 8;
    uint8_t n = opcode & 0x00FF;
...
void Chip8Core::opcode_io(uint16_t opcode)
{
    uint8_t x = (opcode & 0x0F00) >> 8;
    uint8_t n = opcode & 0x00FF;
    bool pressed = false;
